...
def build_network(keep_prob = 0.5, optimizer='adam'):
    ...
    x = Dense(1000, name='hidden1')(inputs)
    x1 = Dense(3, activation='softmax', name='output')(x)
...
model = KerasClassifier(build_fn=build_network, verbose=1, epochs=50, batch_size=1)
